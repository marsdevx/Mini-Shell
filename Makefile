...
SRC_BUILTIN = builtin/builtin.c builtin/utils.c builtin/cd.c builtin/export.c builtin/echo.c
...
SRC_LEXER = lexer/lexer.c lexer/handle.c lexer/handle_utils.c lexer/utils.c lexer/syntax_validator.c lexer/syntax_validator_utils.c
