...
SRC = $(SRC_BUILTIN) $(SRC_EXEC) $(SRC_CORE) $(SRC_LEXER) $(SRC_PARSER) $(SRC_READER) $(SRC_UTILS)
...
$(OBJDIR):
	mkdir -p $(OBJDIR)/builtin $(OBJDIR)/exec $(OBJDIR)/core $(OBJDIR)/lexer $(OBJDIR)/parser $(OBJDIR)/reader $(OBJDIR)/utils
